...
%o`, message, error2, detail);
  ...
  var spots_registration_controller_default = class extends Controller {
    ...
    `;
      ...
      if (existingFlashContainer) {
        ...
        if (mainContent) {
          const containerDiv = document.querySelector("main > .container:first-child") || document.createElement("div");
    ...
    updateSpotsOrder(category) {
      ...
      spots.forEach((spot, index2) => {
        if (spot.order_number !== index2 + 1) {
          this.updateSpotOrderWithServer(spot.id, index2 + 1);
        }
      });
    }
  ...
  __publicField(spots_registration_controller_default, "targets", ["map", "sightseeingList", "restaurantList", "hotelList", "scheduleList"]);
  ...
  var search_autocomplete_controller_default = class extends Controller {
    connect() {
  ...
  __publicField(search_autocomplete_controller_default, "values", {
    url: String
  });
  ...
  // app/javascript/controllers/travel_image_controller.js
  var travel_image_controller_default = class extends Controller {
    connect() {
    ...
    adjustExistingImage() {
      ...
      if (existingImage) {
        ...
        existingImage.style.objectFit = "fill";
        existingImage.style.maxWidth = "none";
        existingImage.style.maxHeight = "none";
    ...
    async uploadImage(event) {
      ...
      try {
        ...
        console.error("\u753B\u50CF\u30A2\u30C3\u30D7\u30ED\u30FC\u30C9\u30A8\u30E9\u30FC:", error2);
  ...
  __publicField(travel_image_controller_default, "targets", ["imageContainer", "fileInput"]);
  __publicField(travel_image_controller_default, "values", {
    travelId: String
  });
  ...
  application.register("travel-image", travel_image_controller_default);
